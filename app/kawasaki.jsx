    ...
    <View style={styles.container}>
        ...
        <View style={styles.body}>
            ...
            <View style={styles.carBrandsList}>
              <TouchableOpacity onPress={() => navigation.navigate('kawasakiHyperSport')} style={styles.carBrandImageClick} >
                <Image source={require('../assets/HyperSport.png')}  style={styles.carBrandImage} />
              </TouchableOpacity>
              <TouchableOpacity onPress={() => navigation.navigate('')} style={styles.carBrandImageClick} >
                <Image source={require('../assets/SuperSport.png')} style={styles.carBrandImage} />
              </TouchableOpacity>
              <TouchableOpacity onPress={() => navigation.navigate('')} style={styles.carBrandImageClick} >
                <Image source={require('../assets/SuperNaked.png')} style={styles.carBrandImage} />
              </TouchableOpacity>
              <TouchableOpacity onPress={() => navigation.navigate('')} style={styles.carBrandImageClick} >
                <Image source={require('../assets/SportTourer.png')} style={styles.carBrandImage} />
              </TouchableOpacity>
            </View>
        </View>
