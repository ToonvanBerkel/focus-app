        ...
        <View style={styles.bodySettings}>
          <View style={styles.listSettings}>
            <View>
                ...
                <View style={styles.row}>
                    <Text style={styles.listSettingsText}>Username: </Text>
                    <Text style={styles.listSettingsText}>Log in</Text>
                </View>
                <View style={styles.row}>
                    <Text style={styles.listSettingsText}>Password: </Text>
                    <Text style={styles.listSettingsText}>Log in</Text>
                </View>
                <View style={styles.row}>
                ...
                <View style={styles.row}>
                    <Text style={styles.listSettingsText}>Bio: </Text>
                    <Text style={styles.listSettingsText}>Log in</Text>
                </View>
            </View>
          </View>
