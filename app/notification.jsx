        ...
        <View style={styles.bodySettings}>
          <View style={styles.listSettings}>
            <View>
                ...
                <View style={styles.row}>
                    <Text style={styles.listSettingsText}>Updates: </Text>
                    <Text style={styles.listSettingsText}>ON</Text>
                </View>
                <View style={styles.row}>
                    <Text style={styles.listSettingsText}>Motivating Messages: </Text>
                    <Text style={styles.listSettingsText}>ON</Text>
                </View>
                <View style={styles.row}>
                    <Text style={styles.listSettingsText}>Training: </Text>
                    <Text style={styles.listSettingsText}>ON</Text>
                </View>
                <View style={styles.row}>
                    <Text style={styles.listSettingsText}>Newspaper: </Text>
                    <Text style={styles.listSettingsText}>ON</Text>
                </View>
                <Text style={styles.listSettingsBigText}>Notification by: </Text>
                <View style={styles.row}>
                    <Text style={styles.listSettingsText}>Number: </Text>
                    <Text style={styles.listSettingsText}>ON</Text>
                </View>
                <View style={styles.row}>
                    <Text style={styles.listSettingsText}>E-mail: </Text>
                    <Text style={styles.listSettingsText}>ON</Text>
                </View>
                <View style={styles.row}>
                    <Text style={styles.listSettingsText}>App: </Text>
                    <Text style={styles.listSettingsText}>ON</Text>
                </View>
            </View>
          </View>
